  ...
  return (
    <InventarioProvider>
      <div className="flex min-h-screen w-full dark:bg-gray-950">
        {/* SIDEBAR */}
        <nav className={`sticky top-0 h-screen shrink-0 flex flex-col border-r border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 transition-all duration-300 ${sidebarOpen ? 'w-64' : 'w-16'} shadow-sm`}>
          {/* Logo */}
          ...
          <button onClick={() => setSidebarOpen(!sidebarOpen)}
            className="flex items-center border-t border-gray-200 dark:border-gray-800 px-3 py-3 hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors">
        ...
        <div className="flex-1 flex flex-col bg-gray-50 dark:bg-gray-950 min-h-screen">
          {/* Topbar */}
          <header className="sticky top-0 z-10 flex items-center justify-between px-6 py-3 bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-800 shadow-sm">
            <div>
              <h1 className="text-xl font-bold text-gray-900 dark:text-gray-100">{selected}</h1>
              <p className="text-xs text-gray-500 dark:text-gray-400">Sesión de <span className="font-bold text-blue-600">{user.name}</span></p>
            </div>
